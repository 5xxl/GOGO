...
logo = pyfiglet.figlet_format('                ☈*GOGO*☈')
print(X+logo)
print("insta:j1r0")
...
logo = pyfiglet.figlet_format('                ☈*GOGO*☈')
print(X+logo)
print ("  \n                    [\]make Dork : {-d}                          \n                        {\} search Dork : {-s} \n                  {$}Pull links from a page : {-r)")
j1= input("                    ↳>>>>> :")
if (j1=="-s"):
  j2= input ("Enter your Dork: ")
  for i in search (j2, stop=1000):
    print(i)
    print("Done ✓✓✓✓✓✓✓ ")
if (j1=="-r"):
    z=input("Web link : ")
...
if (j1=="-d"):
    d=input("Enter the name of the exploit: ")
if(d=="SQL"):
    print("""
    trainers.php?id=
play_old.php?id=
...
/components/com_extended_registration/registration_detailed.inc.php?mosConfig_absolute_p ath= com_extended_registration
/components/com_extended_registration/registration_detailed.inc.php?mosConfig_absolute_p ath= “com_extended_registration”
/components/com_extended_registration/registration_detailed.inc.php?mosConfig_absolute_p ath=ioiogb;''m(k(6#6#) com_extended_registration
